...
* `HOST` (default: `0.0.0.0`): Per default the web application is accessible from every host. Set it to `127.0.0.1` if the web application should be accessible from every host.
